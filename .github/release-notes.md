> **Cheats are confirmed working on real hardware**, and two things are not.
> A stray `.cht` copied to the card instead of being converted has not been
> tested on a Pocket, and neither has closing the lid while cheats are loaded.
> Back up your saves before using cheats on anything you care about;
> `docs/HARDWARE.md` in the repository is the full checklist.
...
[desktop picker](https://github.com/kroy-the-rabbit/pocket-tools),
